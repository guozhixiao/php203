                    	...
                    	<form action="/admin/user" method="post" class="mws-form" enctype="multipart/form-data">
                    		<div class="mws-form-inline">
                    			...
                    			<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item">
                    					<input type="text" class="small" name="mail">
                    				</div>
                    			</div>
                    			...
                    			<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item clearfix">
                    					<ul class="mws-form-list inline">
                    						<li><input type="radio" name="status" value="1" checked="checked"> <label>激活</label></li>
                    						<li><input type="radio" name="status" value="2" > <label>未激活</label></li>
                    					</ul>
                    				</div>
                    			</div>
                    		</div>
