	...
	<div id="mws-header" class="clearfix">
    	...
    	<div id="mws-logo-container">
        	...
        	<div id="mws-logo-wrap">
            	<img src="/admin/images/203955111665023516.png" alt="mws admin">
			</div>
        </div>
        ...
        <div id="mws-user-tools" class="clearfix">
            ...
            <div id="mws-user-info" class="mws-inset">
                ...
                <div id="mws-user-functions">
                    ...
                    <ul>
                    	<li><a href="/admin/user/2/edit">修改头像</a></li>
                        <li><a href="#">修改密码</a></li>
   ...
   <div id="mws-wrapper">
        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                <ul>
                    <li>
                        <a href="#"><i class="icon-leaf"></i>地址管理</a>
                        <ul class='closed'>
                            <li><a href="/admin/address">前台用户地址</a></li>
            ...
            <div id="mws-navigation">
                <ul>
                    <li>
                        <a href="#"><i class="icon-vimeo"></i>新闻管理</a>
                        <ul class='closed'>
                            <li><a href="/admin/xinwen">浏览新闻</a></li>
                            <li><a href="/admin/xinwen/create">添加新闻</a></li>
                        </ul>
                    </li>
                </ul>
            </div>     
            ...
            <div id="mws-navigation">
                <ul>
                    <li>
                        <a href="#"><i class="icon-planet"></i>友情链接管理</a>
                        <ul class='closed'>
