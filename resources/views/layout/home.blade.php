...
<div class="soubg">
    <div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
            <span class="fl">你好，请<a href="/home/login">登录</a>&nbsp; <a href="/home/zhuce" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|&nbsp;<a href="/home/cart">购物车</a>&nbsp;</span>
            <span class="ss">
                <div class="ss_list">
                    <a href="#">收藏夹</a>
...
<div class="i_bg bg_color">
    ...
    <div class="btmbg">
        <div class="btm">
            ...
            @foreach(session('friends') as $K=>$v)
            <img src="{{$v->urls}}" width="98" height="33" />
            @endforeach
        </div>      
    </div>
    <!--End Footer End -->    
